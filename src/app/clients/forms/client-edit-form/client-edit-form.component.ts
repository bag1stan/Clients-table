...
@Component({
  ...
  styleUrl: './client-edit-form.component.scss',
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class ClientEditFormComponent implements OnInit {
  @Output() createUser = new EventEmitter();

  private readonly dialogRef = inject(MatDialogRef<ClientEditFormComponent>);
  public readonly data: { client: Client } = inject(MAT_DIALOG_DATA);
